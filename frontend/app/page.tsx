  ...
  return (
    <div className="min-h-screen bg-background text-primary-text flex flex-col selection:bg-neutral-800 selection:text-white dark:selection:bg-neutral-200 dark:selection:text-black">
      ...
      <main className="flex-1 flex flex-col">
        ...
        ========================================================================== */}
        <section className="min-h-[calc(100vh-4rem)] flex flex-col items-center justify-center text-center px-6 sm:px-12 relative border-b border-border/80">
          ...
          <div className="absolute bottom-8 left-1/2 -translate-x-1/2 flex flex-col items-center gap-1.5 text-xs text-muted-text select-none">
        ...
        ========================================================================== */}
        <section id="about" className="py-24 px-6 sm:px-12 max-w-5xl mx-auto w-full border-b border-border/80">
        ...
        ========================================================================== */}
        <section className="py-24 px-6 sm:px-12 max-w-5xl mx-auto w-full border-b border-border/80">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            {featuredAIs.map((ai) => (
              <Card key={ai.id} hoverable className="p-6 flex flex-col justify-between">
                <div>
          ...
          {/* Explicit View More CTA per PRD Section 2 */}
        ...
        {/* =========================================================================
            SECTION 4: ONBOARD SECTION & FOOTER
        ========================================================================== */}
        <section className="py-24 px-6 sm:px-12 text-center max-w-3xl mx-auto w-full">
